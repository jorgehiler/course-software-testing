module.exports = {
    commands: [{
        setInputs: function (artist) {
            this.waitForElementVisible(this.elements.youtubeSearch.locateStrategy, this.elements.youtubeSearch.selector, 30000);
        ...
        clickSearch: function () {
            this.waitForElementVisible(this.elements.youtubeSearchButton.locateStrategy, this.elements.youtubeSearchButton.selector, 30000);
        ...
        validateResult: function () {
            this.waitForElementPresent(this.elements.resultTitle.locateStrategy, this.elements.resultTitle.selector, 30000);
            this.api.expect.element(this.elements.resultTitle).text.to.not.equal("");
            this.waitForElementVisible(this.elements.resultDesk.locateStrategy, this.elements.resultDesk.selector, 30000);
